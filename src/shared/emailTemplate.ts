      ...
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
        ...
        <tr>
          <td style="padding: 20px 40px;">
            ...
            <h2 style="color: #333333; font-size: 20px; margin: 25px 0 15px 0;">Zoom Meeting Details</h2>
            <div style="background-color: #e8f4ff; border-radius: 4px; padding: 20px; margin: 20px 0; border-left: 4px solid #0066cc;">
              ...
              <a href="${values.meetingLink}" style="display: inline-block; margin-top: 15px; background-color: #0066cc; color: white; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-weight: bold;">Join Meeting</a>
            </div>
        ...
        <tr>
          <td style="padding: 20px 40px; text-align: center; color: #999999; font-size: 14px; border-top: 1px solid #eeeeee;">
            <p>&copy; 2024 Healthcare Consultants. All rights reserved.</p>
          </td>
        </tr>
      </table>
    </body>
  ...
  const data = {
    ...
    <body style="font-family: Arial, sans-serif; background-color: #f4f4f4; margin: 0; padding: 0;">
      <table border="0" cellpadding="0" cellspacing="0" width="100%" style="max-width: 600px; margin: 20px auto; background-color: #ffffff; border-radius: 8px; box-shadow: 0 4px 8px rgba(0,0,0,0.05);">
        ...
        <tr>
          <td style="padding: 20px 40px;">
            <h1 style="color: #333333; font-size: 24px; margin-bottom: 20px;">Booking Rescheduled</h1>
            <p style="color: #666666; font-size: 16px; line-height: 1.5;">Hello ${values.name},</p>
            ...
            <h2 style="color: #333333; font-size: 20px; margin: 25px 0 15px 0;">Updated Zoom Meeting Details</h2>
            <div style="background-color: #e8f4ff; border-radius: 4px; padding: 20px; margin: 20px 0; border-left: 4px solid #0066cc;">
              <p style="margin: 5px 0; font-size: 16px;"><strong>Meeting ID:</strong> ${values.meetingId}</p>
              <p style="margin: 5px 0; font-size: 16px;"><strong>Password:</strong> ${values.meetingPassword}</p>
              <a href="${values.meetingLink}" style="display: inline-block; margin-top: 15px; background-color: #0066cc; color: white; padding: 12px 25px; text-decoration: none; border-radius: 4px; font-weight: bold;">Join Meeting</a>
